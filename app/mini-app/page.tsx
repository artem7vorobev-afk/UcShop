...
export default function MiniAppHomePage() {
  return (
    <div className="space-y-7 animate-fade-up">
      {/* Hero — Telegram Stars */}
      <Link href="/mini-app/product/telegram-stars" className="block active:scale-[0.98] transition-transform">
        <div className="relative overflow-hidden rounded-3xl border border-[#e50914]/25 bg-gradient-to-br from-[#1a0507] via-[#12060a] to-background p-6 glow-red">
          ...
          <div className="relative">
            ...
            <h2 className="text-2xl font-extrabold tracking-tight">Telegram Stars</h2>
